	...
	<form action="" method="post">
		...
		<table align="center" border="1" cellspacing="14" cellpadding="12" style="color: black" >
			    ...
			    <tr align="center">
			    	...
			    	<td style="color: red"> ID DEL PRODUCTO  </td>
                ...
                <tr align="center">
                	<td colspan="4"> <input type="submit" name="sb" value="Agregar Producto"></td>
                </tr>
		</table>
	</form>
			<?php
			if(isset($_POST['sb']))
			{
				...
				echo "<script>alert('Agregado a la carta exitosamente')</script>";
